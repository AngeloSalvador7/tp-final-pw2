...
class EmpleadosModel
{
    ...
    {
        return $this->database->query("SELECT e.id, e.dni, e.fecha_nacimiento, e.nombre, e.apellido, e.email, e.clave, r.id as id_rol, r.descripcion FROM empleado e LEFT JOIN rol r ON e.id_rol = r.id  where email='$form[email]' and clave='$form[clave]'");
    }
