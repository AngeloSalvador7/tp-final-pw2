...
public function consultarFactura($idViaje){
 ...
 public function agregarCostosAFactura($idViaje,$costoPeaje,$costoViatico,$costoHospedaje,$costoCombustible){
        $this->database->execute("UPDATE factura SET costo_peaje=$costoPeaje,costo_viaticos=$costoViatico,costo_hospedaje=$costoHospedaje,costo_combustible=$costoCombustible where id_viaje=$idViaje");
 }
